...
function Resume(){
    ...
    return (
        ...
        <EducationCard title = {'Bachelors with Honors in Computer Science'} title2={'Bachelors with Honors in Mathematics Honors'} timeframe="August 2021 - December 2024" company></EducationCard>
            ...
            <h2 class ="Name" id="Software" style={{fontSize: 40, marginTop:"1%"}}>Software Engineer</h2>
            ...
            <h2 class ="Name" id="Research" style={{fontSize: 40, marginTop:"1%"}}>Researcher</h2>
            ...
            description="Insert Abstract Here"/>
            <h2 class ="Name" id="Community" style={{fontSize: 40, marginTop:"1%"}}>Community Builder</h2>
